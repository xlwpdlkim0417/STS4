	...
	<table>
		<form method="get" action="input">
			<tr>
				...
				<td><input type="text" name="empno" value="${empp.empno }" readonly/></td>
			</tr>
			<tr>
				<td><label for="ename">이름</label></td>
				<td><input type="text" name="ename" value="${empp.ename }" /></td>
			</tr>
			<tr>
				<td><label for="job">직무</label></td>
				<td><input type="text" name="job" value="${empp.job }" /></td>
			</tr>
			<tr>
				<td><label for="mgr">상급자 사번</label></td>
				<td><input type="text" name="mgr" value="${empp.mgr }" /></td>
			</tr>
			<tr>
				<td><label for="sal">월급</label></td>
				<td><input type="text" name="sal" value="${empp.sal }" /></td>
			</tr>
			<tr>
				<td><label for="comm">보너스</label></td>
				<td><input type="text" name="comm" value="${empp.comm }" /></td>
			</tr>
			<tr>
				<td><label for="detpno">부서번호</label></td>
				<td><input type="text" name="deptno" value="${empp.deptno }" /></td>
			</tr>
			<tr>
				<td><a href="/">홈으로</a></td>
